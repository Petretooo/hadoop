package homework_csv.homework_csv.secondTask;
...
public class ConfigurationSecondTask {
	
	public ConfigurationSecondTask() {
		// TODO Auto-generated constructor stub
	}
	
	public void runSecondTask() throws IOException {
		Configuration conf = new Configuration();
        
        Path inputPath = new Path("hdfs://127.0.0.1:9000/input/SalesJan2009.csv");
        Path outputPath = new Path("hdfs://127.0.0.1:9000/output_task_2");
