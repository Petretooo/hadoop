...
public class ConfigurationThirdTask {
	
	public ConfigurationThirdTask() {
		// TODO Auto-generated constructor stub
	}

	public void runThirdTask() throws IOException {
		Configuration conf = new Configuration();
        
        Path inputPath = new Path("hdfs://127.0.0.1:9000/input/SalesJan2009.csv");
        Path outputPath = new Path("hdfs://127.0.0.1:9000/output_task_3");
